...
b<-data_block_df[,c("meilvl","phaselvl","apsideslvl","sslvl","solarmolvl","monthlvl","edate")] # copy the data block and call it b, for manipulation in the train/test, adding columns and trimming them.
...
for (k in 1:m) {
  ...
  b<-data_block_df[,c("meilvl","phaselvl","apsideslvl","sslvl","solarmolvl","monthlvl","edate")] 
...
p+geom_raster(aes(fill=Percent_in_phase_band),interpolate=TRUE) +
  scale_fill_gradientn(colours=c("#0000FFFF","#FFFFFFFF","#FF0000FF"))  +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Statistical breakout: ENSO band against precession of lunar orbit") +
  labs(y= "ENSO band", x = "Phase of precession of lunar orbit") +
...
p+geom_raster(aes(fill=Percent_in_ss_band),interpolate=TRUE) +
  scale_fill_gradientn(colours=c("#0000FFFF","#FFFFFFFF","#FF0000FF"))  +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Statistical breakout: ENSO band against sunspot count") +
  labs(y= "ENSO band", x = "Sunspot count") +
  guides(fill=guide_legend(title="Percent"))
...
p+geom_raster(aes(fill=Percent_in_eclipse_month_band),interpolate=TRUE) +
  scale_fill_gradientn(colours=c("#0000FFFF","#FFFFFFFF","#FF0000FF"))  +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Statistical breakout: ENSO band against phase of solar year") +
  labs(y= "ENSO band", x = "Phase of solar year") +
  guides(fill=guide_legend(title="Percent"))
...
p+geom_raster(aes(fill=Percent_in_month_band),interpolate=TRUE) +
  scale_fill_gradientn(colours=c("#0000FFFF","#FFFFFFFF","#FF0000FF"))  +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Statistical breakout: ENSO band against phase of eclipse year") +
  labs(y= "ENSO band", x = "Phase of eclipse year") +
  guides(fill=guide_legend(title="Percent"))
...
p+geom_raster(aes(fill=Percent_in_ap_band),interpolate=TRUE) +
  scale_fill_gradientn(colours=c("#0000FFFF","#FFFFFFFF","#FF0000FF"))  +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("Statistical breakout: ENSO band against line of apsides") +
  labs(y= "ENSO band", x = "Apsides") +
  guides(fill=guide_legend(title="Percent"))
...
#  guides(fill=guide_legend(title="Percent"))
#ggsave("meilag12.png",width=widewidth,height=plothite,units=c("in"))
...
# ggsave("truthtable1.png",width=smallwidth,height=plothite,units=c("in"))
